...
privileged aspect ItemController_Roo_Controller {
    ...
    public Collection<Account> ItemController.populateAccounts() {
    ...
    public Collection<ItemTag> ItemController.populateItemTags() {
        return ItemTag.findAllItemTags();
    }
    
    @ModelAttribute("regions")
    public Collection<Region> ItemController.populateRegions() {
